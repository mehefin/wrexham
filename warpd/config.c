...
static struct {
	...
	{ "grid_activation_key", "A-M-space", "Activates grid mode and allows for further manipulation of the pointer using the mapped keys.", OPT_KEY },
	...
	{ "activation_key", "M-space", "Activate normal movement mode (manual (c)ursor movement).", OPT_KEY },
	...
	{ "exit", "M-q", "Exit the currently active warpd session.", OPT_KEY },
	...
	{ "buttons", "j k l",  "A space separated list of mouse buttons (2 is middle click).", OPT_BUTTON },
	...
	{ "left", "a", "Move the cursor left in normal mode.", OPT_KEY },
	{ "down", "s", "Move the cursor down in normal mode.", OPT_KEY },
	{ "up", "w", "Move the cursor up in normal mode.", OPT_KEY },
	{ "right", "d", "Move the cursor right in normal mode.", OPT_KEY },
	...
	{ "scroll_down", "z", "Scroll down key.", OPT_KEY },
	{ "scroll_up", "x", "Scroll up key.", OPT_KEY },

	{ "cursor_color", "#cfc9a3", "The color of the pointer in normal mode (rgba hex value).", OPT_STRING },

	{ "cursor_size", "4", "The height of the pointer in normal mode.", OPT_INT },
	{ "repeat_interval", "10", "The number of milliseconds before repeating a movement event.", OPT_INT },
	{ "speed", "460", "Pointer speed in pixels/second.", OPT_INT },
	...
	{ "grid_size", "2", "The thickness of grid lines in pixels.", OPT_INT },
